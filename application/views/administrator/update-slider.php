                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('administrator/update_slider_data'); ?>
                               <input type="hidden" value="<?php echo $sliders['id']; ?>"  name="id">
                                    
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">title</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="title" value="<?php echo $sliders['title']; ?>" class="form-control" placeholder="Title">
                                        </div>
                                    </div>
                                     <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Description</label>
                                        <div class="col-sm-10">
                                            <textarea name="description" class="form-control" placeholder="Description"><?php echo $sliders['description']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Current Slider Image</label>
                                        <div class="col-sm-6">
                                            <img src="<?php echo base_url(); ?>assets/images/sliders/<?php echo $sliders['image']; ?>" width="100px">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">New Slider Image</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="checkbox" value="1" <?php if($sliders['status'] == 1){ echo "checked";} ?> name="status" class="js-single" />
                                        </div>
                                    </div>
