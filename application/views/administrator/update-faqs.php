                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-sm-12">
                                     <?php echo form_open_multipart('administrator/update_faqs_data'); ?>
                                     <input class="form-control" value="<?php echo $faqsDetails['id']; ?>" name="id" type="hidden">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control" value="<?php echo $faqsDetails['question']; ?>" name="question" placeholder="FAQ Question" type="text">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <select name="faq_cat_id" class="form-control form-control-primary">
                                                                    ...
                                                                    <?php foreach($faq_categories as $post) : ?>
                                                                         <option <?php if($faqsDetails['faq_cat_id'] == $post['id']){ echo "selected" ; } ?> value="<?php echo $post['id']; ?>"><?php echo $post['name']; ?></option>
                                                                     <?php endforeach; ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <span class="input-group-addon"><i class="icofont icofont-copy-alt"></i></span>
                                                                        <textarea name="answer" placeholder="Please Provide a valid Formated Product Description!" id="editor2"><?php echo $faqsDetails['answer']; ?></textarea>
                                                                    </div>     
                                                                </div>
                                                            </div>
